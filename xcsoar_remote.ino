...
const int Button_2_pin = 15;    // upper LH button
const int Button_3_pin = 12;    // top button
const int Button_4_pin = 11;   // upper RH button
const int Button_5_pin = 14;   // lower RH button
const int Joy_button_pin = 6; // joystick button
const int Joy_up_pin = 9;
const int Joy_down_pin = 7;
const int Joy_left_pin = 5;
const int Joy_right_pin = 8;
...
const int Mouse_Move_Distance = 3;
